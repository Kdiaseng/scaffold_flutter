...
class UserMockRepository implements IUserRepository {
  ...
  Future<UserPagedResponse> getAllUsers(int page) async {
    return UserPagedResponse.fromJson(data);
  }

  @override
  Future<UserWithSupport> getUserById(int userId) async {
    return UserWithSupport.fromJson(userDetails);
  }
}
